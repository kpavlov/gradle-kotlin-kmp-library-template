...
## 🏔️ PR Size Check
<!-- One of the biggest challenges in code review is PR size! -->
<!-- Smaller PRs = faster reviews = shorter feedback cycles 🔁 -->

**Estimated lines changed:**
- [ ] 🟢 Small (< 200 lines) - Quick review
- [ ] 🟡 Medium (200-500 lines) - Needs focused time
- [ ] 🔴 Large (500+ lines) - Consider splitting! 🚨

**If your PR is large, can you split it?**
- [ ] ✅ Yes, I'll create separate PRs for different concerns
- [ ] ❌ No, these changes are tightly coupled
- [ ] 🤔 Maybe - I'll discuss with reviewers first
...
<!-- Especially useful for UI changes! -->
...
<!-- 🤡 Don't let descriptions be misleading! Make sure everything matches -->

### Code Quality
- [ ] 📖 My code follows the project's style guidelines
- [ ] 🔍 I have performed a self-review of my own code
- [ ] 💬 I have commented my code, particularly in hard-to-understand areas
- [ ] 🧹 I have removed any commented-out code and debug statements
- [ ] ⚠️ My code generates no new warnings or errors
...
### Focus & Scope
- [ ] 🎯 This PR stays focused on a single concern
- [ ] 🚫 I haven't included unrelated changes or "drive-by" fixes
- [ ] 📊 The PR description accurately reflects ALL the changes made
...
### ⚡ Quick Context
<!-- Help reviewers get up to speed quickly -->
...
Remember: Smaller PRs → Faster reviews → Shorter cycles → Happier team! 
-->
